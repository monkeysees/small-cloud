...
The user confirmed this product boundary on 2026-09-09 during the [CLI design interview](../cli-design.md). Implemented in #31 using a fixed production entry point and a separate, undistributed HTTPS fixture launcher.
