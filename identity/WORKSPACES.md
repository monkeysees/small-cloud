...
Ownership transfer/delegation, removal/readmission, suspension, deletion, and configurable workspace allowances remain subsequent tickets. Local acceptance uses real CLI/HTTPS, signed Google fixtures and real PostgreSQL; deployed multi-workspace infrastructure acceptance remains #28.
