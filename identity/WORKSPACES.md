...
Ownership transfer/delegation, removal/readmission, suspension, deletion, and configurable workspace allowances remain subsequent tickets. [Local acceptance](../docs/acceptance/workspaces-2026-09-10.md) uses real CLI/HTTPS, signed Google fixtures and real PostgreSQL. [Hosted acceptance](../docs/acceptance/workspaces-hosted-2026-09-11.md) verified the upgrade, two real builds, isolation and restart; fresh Google approval and visual browser checks remain manual. Complete-service acceptance remains #28 after its predecessor workflows land.
